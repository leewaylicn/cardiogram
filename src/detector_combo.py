...
from basic import BaseAggregator
from score_comb import average, maximization, median


class ScollingDetectorAggregator(BaseAggregator):
    """A collection of Soclling detector combination methods.
    ...
    def __init__(self, base_estimators, method='average', contamination=0.1,
        ...
        super(ScollingDetectorAggregator, self).__init__(
    ...
    def _create_scores(self, X):
        ...
        for i, clf in enumerate(self.base_estimators):
            if hasattr(clf, 'decision_function'):
                all_scores[:, i] = clf.decision_function(X)[0]
            else:
                raise ValueError(
